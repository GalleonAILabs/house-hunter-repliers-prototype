...
- Live phone tunnel: stable named Cloudflare Tunnel at `https://househunter.galleonglobal.ai` (permanent URL). Start the forwarder with `cloudflared tunnel run house-hunter`. Replaced flaky localtunnel and an earlier random-URL quick tunnel.
